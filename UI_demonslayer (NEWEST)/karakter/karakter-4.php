...
<html lang="en">
  <head>
    ...
    <title>Karakter - Inosuke Hashihira</title>
    ...
    <div class="main" id="karakter">
      <div class="main__container">
        <div class="main__img--container">
          <img src="./img/karakter/d.png" alt="Demon Slayer" width="316.8" height="671"/>
        </div>
        <div class="main__content">
          <h1>Inosuke Hashihira</h1>
          <ul type='bullet'>
            <li>Biodata<br>
              Umur: 15 tahun <br>
              Tanggal lahir: 22 April <br> 
              Tinggi badan: 164 cm <br>
              <br>
              ...
              <br><br>
              Inosuke dibesarkan babi hutan. Ini terefleksikan dengan pemilihan topeng yang dia kenakan. Latar belakang ini mengisyaratkan kalau dia bertarung melawan tradisi, emosi dan adat istiadat manusia. Namun, berkat afiliasinya dengan Demon Slayer Corps, perlahan-lahan, dia mulai berubah.</li>
              <br>
            <li>Teknik Pernafasan<br>
              <ol type='1'>
                <li>Teknik Pernafasan Binatang Buas</li>
                </ol>
              </li>
            </ul>
        </div>
