...
<html lang="en">
  <head>
    ...
    <title>Karakter - Mitsuri Kanroji</title>
    ...
    <div class="main" id="karakter">
      <div class="main__container">
        <div class="main__img--container">
          <img src="../img/karakter/n.png" alt="Demon Slayer" width="316.8" height="671"/>
        </div>
        <div class="main__content">
          ...
          <ul type='bullet'>
            <li>Biodata<br>
              Umur: 19 tahun <br>
              Tanggal lahir: 1 Juni <br>
              Tinggi badan: 167 cm <br>
              <br>
              ...
              <br><br>
              Sebagai pengguna teknik Breath of Love, Kanroji menggunakan pedang unik yang hanya bisa ia gunakan. Pedangnya sangat tipis dan lembut, sehingga dirinya menggunakan pedangnya sebagai semacam cambuk.</li>
              <br>
            <li>Teknik Pernafasan<br>
              <ol type='1'>
                <li>Teknik Pernafasan Cinta</li>
                </ol>
              </li>
            </ul>
        </div>
