...
<html lang="en">
  <head>
    ...
    <title>Karakter - Kanao Tsuyuri</title>
    ...
    <div class="main" id="karakter">
      <div class="main__container">
        <div class="main__img--container">
          <img src="./img/karakter/e.png" alt="Demon Slayer" width="316.8" height="671"/>
        </div>
        <div class="main__content">
          ...
          <ul type='bullet'>
            <li>Biodata<br>
              Umur : 16 tahun <br>
              Tanggal lahir : 19 Mei <br>
              Tinggi badan : 156 cm <br>
              <br>
              ...
              <br><br>
              Dia juga menolak untuk membuat keputusan untuk dirinya sendiri. Dia memilih meninggalkan masalah seperti itu kepada orang lain atau peluang. Di antara karakter paling heroik di Demon Slayer, Kanao cukup dewasa sepanjang serial ini berjalan. Meskipun ini hanya terlihat di anime.</li>
              <br>
            <li>Teknik Pernafasan<br>
              <ol type='1'>
                <li>Teknik Pernafasan Bunga</li>
                </ol>
              </li>
            </ul>
        </div>
