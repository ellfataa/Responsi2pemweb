...
<html lang="en">
  <head>
    ...
    <title>Karakter - Kagaya Ubuyashiki</title>
    ...
    <div class="main" id="karakter">
      <div class="main__container">
        <div class="main__img--container">
          <img src="./img/karakter/j.png" alt="Demon Slayer" width="316.8" height="671"/>
        </div>
        <div class="main__content">
          <h1>Kagaya Ubuyashiki</h1>
          <ul type='bullet'>
            <li>Biodata<br>
              Umur: 23 tahun <br>
              Tanggal lahir: Tidak diketahui <br>
              Tinggi badan: Tidak diketahui <br>
              <br>
              ...
              <br><br>
              Dia juga menjadi kepala keluarga Ubuyashiki. Meskipun saat ini kondisinya lemah, dia pernah dikenal sebagai orang yang sangat kuat yang ditakuti. Saat ini Kagaya menjadi lemah karena Demon Slayer Mark-nya dan kesehatannya yang semakin memburuk.</li>
              <br>
